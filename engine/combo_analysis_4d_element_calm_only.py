#!/usr/bin/env python3
"""
4D Analysis: CALM CONDITION ONLY
Condition: Calm | Round Type × Color × Element
"""
...
def main():
    parser = argparse.ArgumentParser(description="4D (Filtered): Calm Condition Only")
    ...
    # Print summary
    print(f"\n{'='*110}")
    print("4D ANALYSIS (FILTERED) - CALM CONDITION ONLY")
    print("="*110)
    ...
    csv_path = os.path.join(OUTPUT_DIR, f"4d_element_calm_only{year_suffix}.csv")
